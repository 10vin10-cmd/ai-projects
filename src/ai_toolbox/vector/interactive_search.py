...
"""
Run the interactive search system to test its functionality:


python3 interactive_search.py

Note: This will use shared_functions.py to load the food dataset and perform similarity searches. You can enter search queries interactively in the terminal.
